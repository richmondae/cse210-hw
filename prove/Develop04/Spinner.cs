...
public class Spinner
{
    ...
    public void ShowSimplePercentage()
    {
        for (int i = 0; i <= 100; i++)
        {
            Console.Write($"\rGear up... {i}%   ");
            Thread.Sleep(50);
        }
        Console.Write("\rGear up...      ");
    }
    ...
    public void ShowSpinnerReady()
    {
        ...
        for (int i = 0; i < 50; i++)
        {
            switch (counter % 4)
            {
                case 0: Console.Write("Gear up... /"); break;
                case 1: Console.Write("Gear up... -"); break;
                case 2: Console.Write("Gear up... \\"); break;
                case 3: Console.Write("Gear up... |"); break;
            }
